...
ui <- fluidPage(
  ...
  sidebarLayout(
    sidebarPanel(
      ...
      tipify(selectInput('transform', 'Read length summarization',
                  c("polymerase.reads", "all.subreads", "subread.mean", "subread.median"), selected="none"),
             "For Sequel data, return the length of all subreads or summarize within each polymerase subread group"),
